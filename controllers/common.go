...
func (self *BaseController) Prepare() {
	...
	noAuth := "ajaxsave/ajaxdel/table/loginin/loginout/getnodes/start/alinotify/wxnotify/initwshub/oauthnotify/reorder/wx/takeout"
...
func (self *BaseController) auth() {
	...
	if len(arr) == 2 {
		...
		if userId > 0 {
			...
			noAuth := "ajaxsave/ajaxdel/table/loginin/loginout/getnodes/start/show/ajaxapisave/alinotify/wxnotify/initwshub/oauthnotify/reorder/wx/takeout"
			isNoAuth := strings.Contains(noAuth, self.actionName)
