...
func (self *BaseController) Prepare() {
	...
	noAuth := "ajaxsave/ajaxdel/table/loginin/loginout/getnodes/start/alinotify/wxnotify/initwshub/oauthnotify/reorder/wxoauthnotify/takeout"
...
func (self *BaseController) auth() {
	...
	if len(arr) == 2 {
		...
		if userId > 0 {
			...
			noAuth := "ajaxsave/ajaxdel/table/loginin/loginout/getnodes/start/show/ajaxapisave/alinotify/wxnotify/initwshub/oauthnotify/reorder/wxoauthnotify/takeout"
			isNoAuth := strings.Contains(noAuth, self.actionName)
...
func (self *BaseController) AdminAuth() {
	...
	if self.userId != 1 {
		//普通管理员
		adminAuthIds, _ := admin.RoleAuthGetByIds(self.user.RoleIds)
