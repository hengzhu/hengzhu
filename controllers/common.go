...
func (self *BaseController) Prepare() {
	...
	noAuth := "ajaxsave/ajaxdel/table/loginin/loginout/getnodes/start/alinotify/initwshub/oauthnotify"
...
func (self *BaseController) auth() {
	...
	if len(arr) == 2 {
		...
		if userId > 0 {
			...
			noAuth := "ajaxsave/ajaxdel/table/loginin/loginout/getnodes/start/show/ajaxapisave/alinotify/initwshub/oauthnotify"
			isNoAuth := strings.Contains(noAuth, self.actionName)
