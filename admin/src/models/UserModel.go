...
func (u *AdminUser) Valid(v *validation.Validation) {
...
//验证用户信息
func checkAdminUser(u *AdminUser) (err error) {
...
//get AdminUser list
func GetAdminUserlist(page int64, page_size int64, sort string) (users []orm.Params, count int64) {
	o := orm.NewOrm()
	user := new(AdminUser)
...
//添加用户
func AddAdminUser(u *AdminUser) (int64, error) {
	if err := checkAdminUser(u); err != nil {
		return 0, err
	}
	o := orm.NewOrm()
	user := new(AdminUser)
...
//更新用户
func UpdateAdminUser(u *AdminUser) (int64, error) {
	if err := checkAdminUser(u); err != nil {
		return 0, err
	}
	o := orm.NewOrm()
...
func DelAdminUserById(Id int64) (int64, error) {
	o := orm.NewOrm()
	status, err := o.Delete(&AdminUser{Id: Id})
	return status, err
}

func GetAdminUserByUsername(username string) (user AdminUser) {
...
func GetAdminUserById(id int64) (user AdminUser) {
