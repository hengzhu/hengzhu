...
type Log struct {
	...
	CabinetDetailId int       `orm:"column(cabinet_detail_id);null" description:"柜子详情中的id"`
	Action          string    `orm:"column(action);size(255);null" description:"操作"`
	User            string    `orm:"column(user);size(255);null" description:"存物ID/管理员"`
