    ...
    $(function(){
        ...
        $("#datagrid").datagrid({
            ...
            columns:[[
                ...
                {field:'Typename',title:'类型',width:100,align:'center',editor:'text'},
                {field:'Desc',title:'描述',width:600,align:'center',editor:'text'},
            ]],
    ...
    function delrow(){
        $.messager.confirm('Confirm','你确定要删除?',function(r){
            if (r){
                ...
                vac.ajax(URL+'/DelNewsType', {Id:row.Id}, 'POST', function(r){
                    if(r.status){
                        $("#datagrid").datagrid('reload');
                    }else{
                        vac.alert(r.info);
