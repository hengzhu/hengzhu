...
<head>
    ...
    <script type="text/javascript" charset="utf-8" src="/static/easyui/js/gift/jquery.datetimepicker.full.js"></script>
    ...
    <!--<script>$("#datetimepicker").datetimepicker({value:"2015/04/15 05:03",step:10});</script>-->
</head>
